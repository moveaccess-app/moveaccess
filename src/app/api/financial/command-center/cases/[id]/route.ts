...
import { getFinancialCommandCenterCaseDetail } from '@/server/financial/command-center';
...
export async function GET(
  ...
  try {
    ...
    const result = await getFinancialCommandCenterCaseDetail(parsed.data.academyId, id);
