      ...
      <div className="container-wide mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
              <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
              <span className="text-sm text-muted-foreground">Sistema completo para academias</span>
            </div>

            {/* Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.1] tracking-tight mb-6 opacity-0 animate-fade-up" style={{ animationDelay: "0.2s" }}>
              O novo padrão de gestão para{" "}
              <span className="text-gradient">academias.</span>
            </h1>

            {/* Subheadline */}
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 opacity-0 animate-fade-up" style={{ animationDelay: "0.3s" }}>
              Controle de acesso, financeiro, contratos e automações — tudo em um único sistema inteligente.
            </p>

            {/* CTAs */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start opacity-0 animate-fade-up" style={{ animationDelay: "0.4s" }}>
            ...
            {/* Trust badges */}
            <div className="flex items-center gap-4 mt-10 justify-center lg:justify-start opacity-0 animate-fade-up flex-wrap" style={{ animationDelay: "0.5s" }}>
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-card/50 rounded-full border border-border">
                ...
                <span className="text-sm text-muted-foreground">Setup em minutos</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 bg-card/50 rounded-full border border-border">
          ...
          <div className="relative opacity-0 animate-scale-in" style={{ animationDelay: "0.4s" }}>
            <div className="relative animate-float">
              ...
              <div className="absolute -bottom-6 -left-6 glass rounded-xl p-3 shadow-card animate-float" style={{ animationDelay: "0.5s" }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground">Acesso liberado</div>
                    <div className="text-sm font-semibold text-foreground">QR Code ativo</div>
                  </div>
                </div>
              </div>
            </div>
